...
import com.keimons.dispatcher.core.handler.Handlers;
...
public class Dispatchers {
	...
	public static final EnumMap<HandlerType, Handler<Runnable>> DEFAULT_DIRECT_HANDLER =
			new EnumMap<>(HandlerType.class);

	static {
		DEFAULT_DIRECT_HANDLER.put(HandlerType.DEFAULT, Handlers.newDirectHandler());
	}
